...
# Возможно, это из-за того, что я настроил неправильно и вместо "connection-state=new"
# в первых трех правилах нужно ставить "packet-mark=no-mark".
# Жаль, что мне не на чем сейчас проверить, как оно будет работать

# А еще тут же настроены рекурсивные маршруты.
...
# Следующие три маршрута - это те, которые не нужны, если mangle исправить.
